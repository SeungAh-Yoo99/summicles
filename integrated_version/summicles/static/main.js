    ...
    .then(response =>{
        ...
        for(let i=0; i<response.length; i++){
            ...
            if(img===null){
                ul.innerHTML += `
                    <li>
                        <img class="show-article img_here img-article" src="{% static '../static/img/null_article_img.png' %}"/>
                ...
                <div class="popup hide">
                    ...
                    <div class="modal-body">
                        <img class="modal-img-here"  src="{% static '../static/img/null_article_img.png' %}" alt="pic"/>
                ...
                ul.innerHTML += `
                    <li>
                        <img class="show-article img_here img-article" src="${img}" onerror="this.src='{% static "../static/img/null_article_img.jpg" %}'"/>
                        <div class="article-group article_here">
                            <a class="title title_here">${title}</a>
                            <p class="headline-here">${headline}</p>
                ...
                <div class="popup hide">
                    ...
                    <div class="modal-body">
                        <img class="modal-img-here"  src="${img}" alt="pic" onerror="this.src='{% static "../static/img/null_article_img.jpg" %}'"/>
                        <p class="modal-article-here">${contents}</p>
                    </div>
                    <div class="modal-footer clearfix">
                        <button class="btn-close2 float--right">닫기</button>
